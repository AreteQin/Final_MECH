...
{
	float Radian_Temple;
	Radian_Temple = atan2((Goal[1] - Start[1]), (Goal[0] - Start[0]));
...
=======
	x0 = 500;
	y0 = 110;
>>>>>>> ed5c5b2ce23b06d047f1bf71bc7e138a5614a48d
	theta0 = 1.5;
	...
	while (1) {
		...
		PathTrack(OneView, A_Global_Start, B_Global_End, 3.1415926 / 19, 40, objects);     // realize the one-step viewpoint path track
		draw_point_rgb(rgb, OneView[0], OneView[1], 0, 0, 255);                            // draw the view point to track/draw the goal point
